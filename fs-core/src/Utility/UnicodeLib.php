...
class UnicodeLib {
     ...
     */
    public static function convert($string, $encoding = '', $destination = 'UTF-8') {
        if ($encoding == '')
    ...
    public static function strtolower($str) {
        return strtr($str, self::$_UTF8_TABLES['strtolower']);
    }
    ...
    public static function strtoupper($str) {
        return strtr($str, self::$_UTF8_TABLES['strtoupper']);
    }
